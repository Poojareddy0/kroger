...
app.config['Upload_folder_HouseHolds']="/CloudFinalProject/dataset/Households";
app.config['Upload_folder_Transactions']="/CloudFinalProject/dataset/Transactions";
app.config['Upload_folder_Products']="/CloudFinalProject/dataset/Products";
